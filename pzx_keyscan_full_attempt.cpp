...
// 1, 0, 6, 7, 8, 18
// 0  1  2  3  4  5
#define CP_JOIN_FLP(a) (((a>>1)&0x01)|((a<<1)&0x02)|(((a>>4)&0x1C)|((a>>13)&0x20)))
...
#if defined(PICOMPUTER_PICOZX) || defined(ZX_HANDHELD)
  menu = m ? 1 : 0; 
#endif
}
...
static uint8_t kbits[6][6][8] = { 
  ...
  {
#if defined(REAL_ZXKEYBOARD_BOB)
    { HID_KEY_0, HID_KEY_ARROW_LEFT, HID_KEY_ARROW_UP, HID_KEY_ARROW_RIGHT, HID_KEY_ARROW_DOWN, HID_KEY_F1, HID_KEY_F9, HID_KEY_F10 },
#else
...
#if defined(REAL_ZXKEYBOARD_BOB)
    { 
      HID_KEY_ENTER, HID_KEY_ARROW_LEFT, HID_KEY_ARROW_UP, HID_KEY_ARROW_RIGHT, HID_KEY_ARROW_DOWN, HID_KEY_F1, 0, 0 },
#else
    { HID_KEY_ENTER, HID_KEY_ARROW_LEFT, HID_KEY_ARROW_UP, HID_KEY_ARROW_RIGHT, HID_KEY_ARROW_DOWN, HID_KEY_F1, HID_KEY_F11, HID_KEY_F12 },
#endif
    { HID_KEY_B, HID_KEY_H, HID_KEY_V, HID_KEY_Y, HID_KEY_6, HID_KEY_G, HID_KEY_T, HID_KEY_5 },
  ...
  {
#if defined(REAL_ZXKEYBOARD_BOB)
    { 0, 0, 0, 0, 0, HID_KEY_F1, HID_KEY_F9, HID_KEY_F10 },
#else
  ...
  {
    { HID_KEY_ESCAPE, HID_KEY_ARROW_LEFT, HID_KEY_PAGE_UP, HID_KEY_ARROW_RIGHT, HID_KEY_PAGE_DOWN, HID_KEY_ESCAPE, 0, 0 },
    { HID_KEY_B, HID_KEY_H, HID_KEY_V, HID_KEY_Y, HID_KEY_ARROW_DOWN, HID_KEY_G, HID_KEY_T, HID_KEY_ARROW_LEFT },
    { HID_KEY_N, HID_KEY_J, HID_KEY_C, HID_KEY_U, HID_KEY_ARROW_UP, HID_KEY_F, HID_KEY_R, HID_KEY_PAGE_DOWN },
    { HID_KEY_M, HID_KEY_K, HID_KEY_X, HID_KEY_I, HID_KEY_ARROW_RIGHT, HID_KEY_D, HID_KEY_E, HID_KEY_3 },
    { HID_KEY_ALT_RIGHT, HID_KEY_L, HID_KEY_Z, HID_KEY_O, HID_KEY_PAGE_UP, HID_KEY_S, HID_KEY_W, HID_KEY_2 },
    { HID_KEY_SPACE, HID_KEY_ESCAPE, HID_KEY_SHIFT_LEFT, HID_KEY_P, HID_KEY_BACKSPACE, HID_KEY_A, HID_KEY_Q, HID_KEY_F1 }
  }  
};
#else
static uint8_t kbits[6][7][7] = { 
  // Normal mappings + cursor SymShift = HID_KEY_ALT_RIGHT
  {
  ...
  // Normal menu mappings
  {
    ...
    { HID_KEY_S, HID_KEY_D, HID_KEY_F, HID_KEY_G, HID_KEY_H, HID_KEY_J, HID_KEY_K },
    { HID_KEY_L, HID_KEY_ENTER, HID_KEY_Z, HID_KEY_X, HID_KEY_C, HID_KEY_V, HID_KEY_B },
    { HID_KEY_N, HID_KEY_M, HID_KEY_SPACE, HID_KEY_F1, HID_KEY_BACKSPACE, HID_KEY_PAGE_UP, HID_KEY_PAGE_DOWN },
  },
  // Shifted menu mappings
  {
    { HID_KEY_ESCAPE, HID_KEY_ARROW_LEFT, HID_KEY_ARROW_UP, HID_KEY_ARROW_RIGHT, HID_KEY_ARROW_DOWN, 0, HID_KEY_ALT_RIGHT },
    ...
    { HID_KEY_S, HID_KEY_D, HID_KEY_F, HID_KEY_G, HID_KEY_H, HID_KEY_J, HID_KEY_K },
    { HID_KEY_L, HID_KEY_ENTER, HID_KEY_Z, HID_KEY_X, HID_KEY_C, HID_KEY_V, HID_KEY_B },
    { HID_KEY_N, HID_KEY_M, HID_KEY_SPACE, 0, HID_KEY_DELETE, 0, 0 },
  },
};
#endif
#else
...
#define COL_TO_BIT(col) (1<<(col-1))
  ...
  #define KEY_ENTER_BIT 0x01
    ...
    #else
      // KC0DRULF
      #define KEY_KEMPSTON_COL 8
      #define KEY_CURSOR_COL 7
      ...
      #define KEY_CURSOR_BIT COL_TO_BIT(KEY_CURSOR_COL)
      #define KEY_KEMPSTON_ROW 0
      #define KEY_KEMPSTON_BIT COL_TO_BIT(KEY_KEMPSTON_COL)
    #endif
    #define KEY_UP_ROW 0
...
void __not_in_flash_func(zx_keyscan_get_hid_reports)(hid_keyboard_report_t const **curr, hid_keyboard_report_t const **prev) {
  ...
  // Spectrum+/128/+2 dedicated keys that are really CAPS SHIFT combinations.
  bool plus_caps_combo =
      ((rdb[KEY_EDIT_ROW]      & KEY_EDIT_BIT)      != 0) ||
      ((rdb[KEY_CAPSLOCK_ROW]  & KEY_CAPSLOCK_BIT)  != 0) ||
      ((rdb[KEY_TRUEVIDEO_ROW] & KEY_TRUEVIDEO_BIT) != 0) ||
      ((rdb[KEY_INVVIDEO_ROW]  & KEY_INVVIDEO_BIT)  != 0) ||
      ((rdb[KEY_GRAPH_ROW]     & KEY_GRAPH_BIT)     != 0) ||
      ((rdb[KEY_EXTEND_ROW]    & KEY_EXTEND_BIT)    != 0) ||
      ((rdb[KEY_BREAK_ROW]     & KEY_BREAK_BIT)     != 0);

  // The dedicated double-quote key is represented as Shift + apostrophe
  // on a PC HID keyboard; the emulator translates that to the Spectrum symbol.
  bool quote_combo = (rdb[KEY_QUOTE_ROW] & KEY_QUOTE_BIT) != 0;
#else
  #ifdef KEY_CURSOR_ROW
  // Cursor mode 
  if (shift) {
...
#else
#ifdef ZX_HANDHELD
  if (shift || plus_caps_combo || quote_combo) chr->modifier |= 2;
#else
